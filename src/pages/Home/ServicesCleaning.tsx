      ...
      <div className="w-full bg-[#fff] grid place-items-center">
        ...
        <div className="w-full max-sm:mt-10 grid lg:grid-cols-4 gap-4 place-items-center">
          <div
            ...
            {...(isLargeScreen && { 'data-aos': 'fade-right', 'data-aos-duration': '1500' })}
          >
            <div className="border-2 rounded-full p-6 absolute -top-12 bg-white text-orange-600">
              <img src={house} alt="house" className="w-16 h-16 object-cover text-orange-600" />
            </div>
            <div className="pt-14 pb-8 px-2 text-center">
              <h1 className="text-2xl font-bold text-orange-600 py-2">House & Office</h1>
              <p className="text-sm">
          ...
          <div
            className="border-2 rounded-lg flex flex-col items-center relative"
            {...(isLargeScreen && { 'data-aos': 'fade-right', 'data-aos-duration': '1000' })}
          >
            <div className="border-2 rounded-full p-6 absolute -top-12 bg-white text-orange-600">
              <LayoutPanelTop size={40} />
            </div>
            <div className="pt-14 pb-8 px-2 text-center">
              <h1 className="text-2xl font-bold text-orange-600 py-2">Polly Tank Cleaning</h1>
              <p className="text-sm">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean
                euismod bibendum laoreet. Proin gravida dolor sit amet lacus
                accumsan et viverra justo commodo.
          ...
          <div
            className="border-2 rounded-lg flex flex-col items-center relative"
            {...(isLargeScreen && { 'data-aos': 'fade-left', 'data-aos-duration': '1500' })}
          >
            <div className="border-2 rounded-full p-4 absolute -top-12 bg-white text-orange-600">
              <img src={floor} alt="floor" className="w-16 h-16 object-cover text-orange-600" />
            </div>
            <div className="pt-14 pb-8 px-2 text-center">
              <h1 className="text-2xl font-bold text-orange-600 py-2">Floor Cleaning</h1>
              <p className="text-sm">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean
                euismod bibendum laoreet. Proin gravida dolor sit amet lacus
                accumsan et viverra justo commodo.
          ...
          <div
            className="border-2 rounded-lg flex flex-col items-center relative"
            {...(isLargeScreen && { 'data-aos': 'fade-left', 'data-aos-duration': '1000' })}
          >
            <div className="border-2 rounded-full p-6 absolute -top-12 bg-white text-orange-600">
              <AppWindow size={40} />
            </div>
            <div className="pt-14 pb-8 px-2 text-center">
              <h1 className="text-2xl font-bold text-orange-600 py-2">Window Cleaning</h1>
              <p className="text-sm">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean
                euismod bibendum laoreet. Proin gravida dolor sit amet lacus
                accumsan et viverra justo commodo.
